defmodule TimemanWeb.WorkingTimeControllerTest do
  ...
  @update_attrs %{
    start: ~N[2024-10-08 15:07:00],
    end: ~N[2024-10-08 15:07:00]
  }
  ...
  describe "update working_time" do
    ...
    test "renders working_time when data is valid", %{conn: conn, working_time: %WorkingTime{id: id} = working_time} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2024-10-08T15:07:00",
               "start" => "2024-10-08T15:07:00"
             } = json_response(conn, 200)["data"]
    end
...
defmodule TimemanWeb.WorkingTimeControllerTest do
  ...
  @update_attrs %{
    start: ~N[2024-10-08 15:24:00],
    end: ~N[2024-10-08 15:24:00]
  }
  @invalid_attrs %{start: nil, end: nil}
  ...
  describe "create working_time" do
    test "renders working_time when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2024-10-07T15:24:00",
               "start" => "2024-10-07T15:24:00"
             } = json_response(conn, 200)["data"]
    end
  ...
  describe "update working_time" do
    ...
    test "renders working_time when data is valid", %{conn: conn, working_time: %WorkingTime{id: id} = working_time} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2024-10-08T15:24:00",
               "start" => "2024-10-08T15:24:00"
             } = json_response(conn, 200)["data"]
    end
