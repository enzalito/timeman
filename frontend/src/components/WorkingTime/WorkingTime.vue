...
const formSchema = toTypedSchema(
  z.object({
    start: z.string().refine((v) => v, { message: "Start date required." }),
    end: z.string().refine((v) => v, { message: "End date required" }),
    endTime: z.string().refine((v) => v, { message: "time required" }),
    startTime: z.string().refine((v) => v, { message: "time required" })
  })
)
          ...
          <FormField name="startTime">
            <FormItem>
              <Input
                ...
                @update:modelValue="(v) => setFieldValue('startTime', String(v))"
              />
            </FormItem>
          </FormField>
        </div>
          ...
          <FormField name="endTime">
            <FormItem>
              <Input
                ...
                @update:modelValue="(v) => setFieldValue('endTime', String(v))"
              />
            </FormItem>
          </FormField>
        </div>
